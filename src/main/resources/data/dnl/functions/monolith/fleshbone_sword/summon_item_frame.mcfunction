summon glow_item_frame ~ ~1 ~ {Facing: 1b, Invulnerable: 1b, Fixed: 0b, Tags: ["dnl.item_frame", "dnl.tick", "dnl.monolith", "dnl.monolith.crafter", "dnl.fleshbone_sword", "dnl.new"], Item: {}}
...
execute as @e[type=glow_item_frame, tag=dnl.new] run function dnl:monolith/fleshbone_sword/copy_data
