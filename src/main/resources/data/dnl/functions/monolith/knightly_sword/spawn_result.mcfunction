...
execute as @e[type=marker, tag=dnl.monolith, distance=..1.1] if score @s dnl.lid = #dnl.monolith.lid dnl.lid run function dnl:monolith/knightly_sword/reset_marker
...
loot spawn ~ ~ ~ loot dnl:item/knightly_sword
