...
tag @s add dnl.monolith.ingredient_1
...
execute as @e[type=marker, tag=dnl.monolith, distance=..1.1] if score @s dnl.lid = #dnl.monolith.lid dnl.lid run function dnl:monolith/knightly_sword/ingredient_1/send_data
