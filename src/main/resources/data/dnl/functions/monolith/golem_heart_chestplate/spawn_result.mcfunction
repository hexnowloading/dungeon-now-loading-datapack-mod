...
execute as @e[type=marker, tag=dnl.monolith, distance=..1.1] if score @s dnl.lid = #dnl.monolith.lid dnl.lid run function dnl:monolith/golem_heart_chestplate/reset_marker
...
loot spawn ~ ~ ~ loot dnl:item/golem_heart_chestplate
