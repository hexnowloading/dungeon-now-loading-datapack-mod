...
execute if score #dnl.monolith.ingredient_6 dnl.boolean matches 0 if score #dnl.monolith.ingredient_6_nbt dnl.boolean matches 0 run function dnl:monolith/golem_heart_chestplate/ingredient_6/matched
