...
execute if score #dnl.monolith.ingredient_7 dnl.boolean matches 0 if score #dnl.monolith.ingredient_7_nbt dnl.boolean matches 0 run function dnl:monolith/golem_heart_chestplate/ingredient_7/matched
