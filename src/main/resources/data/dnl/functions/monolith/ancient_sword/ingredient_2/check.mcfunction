...
scoreboard players reset #dnl.monolith.ingredient_2_nbt dnl.boolean
execute store success score #dnl.monolith.ingredient_2_int_a dnl.int run data get storage dnl:monolith/container Item.tag.Enchantments[{id: "minecraft:vanishing_curse"}].lvl
