...
execute if score #dnl.monolith.ingredient_1 dnl.boolean matches 0 if score #dnl.monolith.ingredient_1_nbt dnl.boolean matches 0 run function dnl:monolith/honey_potion/ingredient_1/matched
