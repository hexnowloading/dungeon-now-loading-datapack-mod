...
execute if score #dnl.monolith.ingredient_4 dnl.boolean matches 0 if score #dnl.monolith.ingredient_4_nbt dnl.boolean matches 0 run function dnl:monolith/golem_heart_boots/ingredient_4/matched
