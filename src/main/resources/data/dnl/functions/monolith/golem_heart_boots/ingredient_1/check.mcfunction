...
execute if score #dnl.monolith.ingredient_1 dnl.boolean matches 0 if score #dnl.monolith.ingredient_1_nbt dnl.boolean matches 0 run function dnl:monolith/golem_heart_boots/ingredient_1/matched
