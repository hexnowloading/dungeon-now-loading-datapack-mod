...
execute if score #dnl.monolith.ingredient_3 dnl.boolean matches 0 if score #dnl.monolith.ingredient_3_nbt dnl.boolean matches 0 run function dnl:monolith/honeycomb_ingot/ingredient_3/matched
