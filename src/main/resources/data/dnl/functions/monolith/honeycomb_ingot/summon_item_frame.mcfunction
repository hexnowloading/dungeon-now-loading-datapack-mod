summon glow_item_frame ~ ~1 ~ {Facing: 1b, Invulnerable: 1b, Fixed: 0b, Tags: ["dnl.item_frame", "dnl.tick", "dnl.monolith", "dnl.monolith.crafter", "dnl.honeycomb_ingot", "dnl.new"], Item: {}}
...
execute if entity @s[tag=dnl.monolith.ingredient_6] run scoreboard players set #dnl.monolith.ingredient_6 dnl.boolean 1
scoreboard players reset #dnl.monolith.ingredient_7 dnl.boolean
execute if entity @s[tag=dnl.monolith.ingredient_7] run scoreboard players set #dnl.monolith.ingredient_7 dnl.boolean 1
scoreboard players reset #dnl.monolith.ingredient_8 dnl.boolean
execute if entity @s[tag=dnl.monolith.ingredient_8] run scoreboard players set #dnl.monolith.ingredient_8 dnl.boolean 1
execute as @e[type=glow_item_frame, tag=dnl.new] run function dnl:monolith/honeycomb_ingot/copy_data
