...
execute store success score #dnl.monolith.ingredient_6 dnl.boolean run data modify storage dnl:monolith/container Item.tag.dnl.name set from storage dnl:monolith/ingredients Ingredients[6].name
