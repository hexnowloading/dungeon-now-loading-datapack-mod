summon area_effect_cloud ~ ~-1 ~ {Tags: ["dnl.area_effect_cloud", "dnl.chaos_spawner.mining_fatigue_spell", "dnl.new"], Particle: "witch", ReapplicationDelay: 20, Radius: 3.0f, RadiusPerTick: 0.075f, RadiusOnUse: -0.5f, Duration: 150, WaitTime: 10, Effects: [{Id: 4b, Amplifier: 2b, Duration: 100, ShowParticles: 1b}, {Id: 20b, Amplifier: 4b, Duration: 100, ShowParticles: 1b}]}
