...
execute unless score #dnl.the_champion.guard_count dnl.int matches 3.. run summon minecraft:marker ~ ~ ~ {Tags: ["dnl.marker", "dnl.skill", "dnl.the_champion", "dnl.the_champion.spawner", "dnl.the_champion.miner_spawner"]}
